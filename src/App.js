    ...
    const browserRouter = <><BrowserRouter>
        <nav className="nav">
            <ul>
                ...
                <li>
                    <NavLink className={(object) => object.isActive ? 'active-link' : ''}
                             to="/products">Продукты</NavLink>
                </li>
                <li>
                    <NavLink className={(object) => object.isActive ? 'active-link' : ''} to="/about">О
                        нас</NavLink>
                </li>
                <li>
                    <NavLink className={(object) => object.isActive ? 'active-link' : ''}
                ...
                <li>
                    <NavLink className={(object) => object.isActive ? 'active-link' : '165'}
                             to="/posts">Пост</NavLink>
                </li>
            </ul>
        </nav>
        <Routes>
